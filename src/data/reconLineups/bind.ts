...
const bind_data: Lineup[] = [
    ...
    },
    {
        ...
        images: [
            {
                link: 'https://i.imgur.com/1wMfkIE.png'
            }
        ],
        bounces: 1,
        charges: 1,
        info: "This dart lands behind them on B short, forcing someone to turn around, or be scanned. It has a fast execution and enough travel time for you to peek out when it lands, even if you slow walk.  Aim where the red drapes meet the ceiling. Make sure you delay this shot, because most people chill in market for the first several seconds of a round. The only downside is that it doesn't reach into market. Thanks to redditor u/KhigenNA for finding this dart!"
    },
    {
        id: 6,
    ...
    },
    {
        ...
        images: [
            {
                link: 'https://i.imgur.com/95NQOUQ.png'
            }
        ],
        bounces: 0,
        charges: 1,
        info: "This is for shower pushes and covers a deep area for you to get the orb if it doesn't scan anyone. Align the bottom left hand corner of your charge bar with the top left of the AC unit. It doesn't scan anyone in the red spot"
    },
    {
        id: 8,
    ...
    },
    {
        ...
        images: [
            {
                link: 'https://i.imgur.com/cXcmbh9.png'
            }
        ],
        bounces: 1,
        charges: 1,
        info: "Good dart for shower pushes when you know they have an awper since it fully exposes heaven. Has a quick execution. There isn't much to say about this dart other than point it at the left antenna."
    }
];
