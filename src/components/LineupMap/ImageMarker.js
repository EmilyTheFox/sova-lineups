...
var ImageMarker = function (_a) {
    var src = _a.src, markers = _a.markers, onAddMarker = _a.onAddMarker, MarkerComponent = _a.markerComponent, _b = _a.bufferLeft, bufferLeft = _b === void 0 ? DEFAULT_BUFFER : _b, _c = _a.bufferTop, bufferTop = _c === void 0 ? DEFAULT_BUFFER : _c, _d = _a.alt, alt = _d === void 0 ? 'Markers' : _d, _e = _a.extraClass, extraClass = _e === void 0 ? '' : _e;
    ...
    return (React.createElement("div", { className: "image-marker" },
        React.createElement("img", { src: src, alt: alt, onClick: handleImageClick, className: 'image-marker__image ' + extraClass, ref: imageRef }),
        markers.map(function (marker, itemNumber) { return (React.createElement("div", { className: "image-marker__marker " + (!MarkerComponent && 'image-marker__marker--default'), style: getItemPosition(marker), key: itemNumber, "data-testid": "marker" }, MarkerComponent ? (React.createElement(MarkerComponent, __assign({}, marker, { itemNumber: itemNumber }))) : (itemNumber + 1))); })));
};
