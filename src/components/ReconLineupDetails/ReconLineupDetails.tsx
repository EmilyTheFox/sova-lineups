...
function ReconLineupDetails(props: { lineup: Lineup | {} }) {
    ...
    let lineup = Object.keys(props.lineup).length > 0 ? props.lineup as Lineup : null;
        ...
        <>
            {
                (lineup !== null) ? (
                    ...
                    <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <h1 style={{ color: 'rgb(15, 25, 35)', fontWeight: '600', fontSize: '3rem', padding: '5%' }}>There aren't any lineups here yet for <span style={{ textTransform: 'capitalize', color: 'rgb(255, 70, 85)' }}>{mapContext.mapState.map}</span>. We will add some soon!</h1>
                    </div>
                )
            }
        </>
